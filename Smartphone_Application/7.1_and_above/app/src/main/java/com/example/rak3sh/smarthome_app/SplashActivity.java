...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String flagg=pref.getString("flagg",null);
        ...
        Toast.makeText(getApplicationContext(),("Hello,"+User),Toast.LENGTH_SHORT).show();}
            ...
            if ((User != "") && (User != null)) {
                ...
                String u = "http://phpexampl.000webhostapp.com/test.php?opt=x";
                Log.d(u, "xx");
...
//new intent for main activity
                            ...
                            Log.e(String.valueOf(app11), "test");
                            ...
                            Intent q = new Intent(SplashActivity.this, login.class);
                            startActivity(q);
                            e.printStackTrace();
                            finish();
                        }
